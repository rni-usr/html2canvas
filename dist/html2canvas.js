...
var _Size = __webpack_require__(33);
...
var _borderRadius = __webpack_require__(35);

var _display = __webpack_require__(36);

var _float = __webpack_require__(37);

var _font = __webpack_require__(38);

var _letterSpacing = __webpack_require__(39);

var _lineBreak = __webpack_require__(40);

var _listStyle = __webpack_require__(8);

var _margin = __webpack_require__(41);

var _overflow = __webpack_require__(42);
...
var _textShadow = __webpack_require__(43);

var _textTransform = __webpack_require__(20);

var _transform = __webpack_require__(44);

var _visibility = __webpack_require__(45);

var _wordBreak = __webpack_require__(46);
...
var _cssLineBreak = __webpack_require__(48);
...
exports.reuseWindow = exports.cloneWindow = exports.DocumentCloner = undefined;
...
var _ResourceLoader = __webpack_require__(56);
...
var _PseudoNodeContent = __webpack_require__(57);
...
var cloneWindow = exports.cloneWindow = function cloneWindow(ownerDocument, bounds, referenceElement, options, logger, renderer, onCloneWindowReady, existingCloner, iFrameContainerRef) {
    if (existingCloner && iFrameContainerRef) {
        var parentSelector = getParentNodeSelector(referenceElement);
        var childIndex = getChildNodeIndex(referenceElement);
        var clonedElement = iFrameContainerRef.contentWindow.document.querySelector(parentSelector).children[childIndex];
        return reuseWindow(ownerDocument, bounds, clonedElement, options, logger, renderer, existingCloner, iFrameContainerRef);
    }
    ...
    return createIframeContainer(ownerDocument, bounds).then(function (cloneIframeContainer) {
        ...
        var iframeLoad = iframeLoader(cloneIframeContainer).then(function () {
            ...
            return cloner.clonedReferenceElement instanceof cloneWindow.HTMLElement || cloner.clonedReferenceElement instanceof ownerDocument.defaultView.HTMLElement || cloner.clonedReferenceElement instanceof HTMLElement ? typeof onclone === 'function' ? Promise.resolve().then(function () {
                return onclone(documentClone, cloner, cloneIframeContainer);
            }).then(function () {
                return result;
...
var reuseWindow = exports.reuseWindow = function reuseWindow(ownerDocument, bounds, clonedElement, options, logger, renderer, cloner, iFrameContainerRef) {
    return Promise.resolve(iFrameContainerRef).then(function (cloneIframeContainer) {
        var cloneWindow = cloneIframeContainer.contentWindow;
        var documentClone = cloneWindow.document;
        ...
        var iframeLoad = Promise.resolve(cloneIframeContainer).then(function () {
            // cloner.scrolledElements.forEach(initNode);
            cloneWindow.scrollTo(bounds.left, bounds.top);
            if (/(iPad|iPhone|iPod)/g.test(navigator.userAgent) && (cloneWindow.scrollY !== bounds.top || cloneWindow.scrollX !== bounds.left)) {
                documentClone.documentElement.style.top = -bounds.top + 'px';
            ...
            var result = Promise.resolve([cloneIframeContainer, clonedElement, cloner.resourceLoader]);

            return clonedElement instanceof cloneWindow.HTMLElement || clonedElement instanceof ownerDocument.defaultView.HTMLElement || clonedElement instanceof HTMLElement ? result : Promise.reject( true ? 'Error finding the ' + clonedElement.nodeName + ' in the cloned document' : '');
        });
...
var _NodeParser = __webpack_require__(31);
...
var renderElement = exports.renderElement = function renderElement(element, options, logger, onCloneWindowReady, cloner, iFrameContainerRef) {
    var ownerDocument = element.ownerDocument;
    ...
    _Feature2.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(false)).then(function (supportForeignObject) {
        ...
        }(new _Clone.DocumentCloner(element, options, logger, true, renderElement)) : (0, _Clone.cloneWindow)(ownerDocument, windowBounds, element, options, logger, renderElement, onCloneWindowReady, cloner, iFrameContainerRef).then(function (_ref2) {
...
var _StackingContext = __webpack_require__(32);
...
var _Trie = __webpack_require__(50);

var _linebreakTrie = __webpack_require__(51);
...
var _Angle = __webpack_require__(55);
